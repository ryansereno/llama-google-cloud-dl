...
```sh
curl -o- https://raw.githubusercontent.com/ryansereno/llama-google-cloud-dl/main/llama.sh | bash
```
...
```
```sh
curl -o- https://raw.githubusercontent.com/ryansereno/llama-google-cloud-dl/main/llama.sh | $(brew --prefix)/bin/bash
```
